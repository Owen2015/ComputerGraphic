...
public class cGeometry {
	...
	public static boolean IsPtInRect(double []pt,double[] rect0,double[] rect1,double[] rect2,double[] rect3){
		...
		double c1=LVector.dotProduct(LVector.subtract(pt, rect0), LVector.subtract(rect1, rect0));
		double c2=LVector.dotProduct(LVector.subtract(rect1, rect0), LVector.subtract(rect1, rect0));
		double c3=LVector.dotProduct(LVector.subtract(pt, rect0), LVector.subtract(rect3, rect0));
		double c4=LVector.dotProduct(LVector.subtract(rect3, rect0), LVector.subtract(rect3, rect0));
		return c1>=0&&c2>=0&&c2>=c1&&c3>=0&&c4>=0&&c4>=c3;
	}
  	public static double Direction(double[] pt1,double pt2[],double[] pt3){
		return LVector.crossProduct2D(LVector.subtract(pt3, pt1), LVector.subtract(pt2, pt1));
	}
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
     	...
     	System.out.println("point in rect? "+cGeometry.IsPtInRect(pt1,rect1));
     	System.out.println("segment intersect? "+cGeometry.IsIntersect(pt1, rect1[3], rect1[0], rect1[1]));
	}
